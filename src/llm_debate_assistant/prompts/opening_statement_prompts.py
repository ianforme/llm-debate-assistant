...
【你的任务】
你的任务是根据论点、论证和论据，利用 `web_search` 工具寻找相关的支持性证据。
...
2. 无论输入语言是什么，只能使用此证据的**原始语言**输出，严禁进行任何翻译。
...
5. 最多只能提出 3 个论点。
6. 写作风格要求：
    6.1 必须事实准确、逻辑严谨、正式且基于证据。
    6.2 避免使用学术/专业术语，确保完全没有背景知识的观众也能理解。
    6.3 必须使用完整段落（不能使用bullet points、括号等在口语表达中无法体现的写作方式）。
